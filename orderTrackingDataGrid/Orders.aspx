...
<head id="Head1" runat="server">
   ...
   <link rel="stylesheet" href="menustyle.css"/>
    ...
    border-image: url(border.png) 30 round;background-image:url(bak1.png);" runat="server">
          <h1 style="position:absolute;top:0px">Rogue Transportation Order Tracking For Delivered Orders</h1> <br /><br />
       ...
       <asp:linkbutton ID="Linkbutton2"  runat="server" style="position:absolute;left:20px;margin-top:20px;color:black;"  OnClientClick="PopupPicker('TextBoxG2', 250, 250)">Pickup End Date</asp:linkbutton>
